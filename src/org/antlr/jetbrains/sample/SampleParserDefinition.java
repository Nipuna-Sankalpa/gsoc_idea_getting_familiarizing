...
public class SampleParserDefinition implements ParserDefinition {
        ...
        return new ANTLRParserAdaptor(SampleLanguage.INSTANCE, parser) {
            ...
            protected ParseTree parse(Parser parser, IElementType root) {
                ...
                if (root instanceof IFileElementType) {
                    return ((SampleLanguageParser) parser).parse();
                }
                // let's hope it's an ID as needed by "rename function"
                return ((SampleLanguageParser) parser).stream_id();
            }
        };
    }
     ...
     * must be a CompositeElement! The org.antlr.jetbrains.adaptor calls
    ...
    public PsiElement createElement(ASTNode node) {
        ...
        switch (ruleElType.getRuleIndex()) {
            case SampleLanguageParser.RULE_definition_stream:
